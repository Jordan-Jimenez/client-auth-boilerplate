...
var ResetPasswordViewModel = /** @class */ (function () {
    function ResetPasswordViewModel(client, data, resetToken, submitAction) {
        var _this = this;
        this.client = client;
        this.data = data;
    ...
    __decorate([
        observable
    ], ResetPasswordViewModel.prototype, "apiError", void 0);
    __decorate([
        observable
    ], ResetPasswordViewModel.prototype, "authToken", void 0);
